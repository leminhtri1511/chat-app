...
class AppValid {
  AppValid._();
  static RegExp specialCharsCheck = RegExp(r'[`~!@#$%^&*()"-=_+{};:\|.,/?]');
  
  static RegExp numberCheck = RegExp('0123456789');

  static RegExp moneyCharsCheck = RegExp(r'^\d+$');

  static int topicMinimumLenght = 6;
  
  static int descriptionMinimumLenght = 10;
